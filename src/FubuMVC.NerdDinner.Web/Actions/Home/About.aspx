<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/Site.Master" Inherits="FubuDinner.Web.Actions.Home.About" %>
...
<asp:Content ID="aboutContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="about">
         <p><img src="<%= "~/Content/nerd.jpg".ToFullUrl() %>" height="200" style="float:left; padding-right:20px" alt="Picture of a huge nerd."/>Are you a huge nerd? Perhaps a geek? No? Maybe a dork, dweeb or wonk. 
         ...
         <p>We're free and fun. <%= this.LinkTo<HomeModel>().Text("Find a dinner near you") %>,
          or <%= this.LinkTo<CreateDinner>().Text("host a dinner") %>. Be social.</p>
